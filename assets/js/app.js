	...
	function(data) {
		try
        {
			...
			if(res.ok == 'TRUE')
			{
				...
				$('.paytable .payfund').html("<input value=\""+res.fund+"\" onclick=\"this.select();\" style=\"width:100%;outline:none;\"/>");
				$('.paytable .paybill').html("<input value=\""+res.bill+"\" onclick=\"this.select();\" style=\"width:100%;outline:none;\"/>");
